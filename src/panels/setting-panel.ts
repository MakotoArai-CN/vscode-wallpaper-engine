            ...
            async (message: any) => {
                if (message.command === 'updateProp') {
                    ...
                    this.server.updateCssConfig({
                        ...
                        adaptiveColorsRespectTransparency: nextConfig.adaptiveColors.respectTransparency,
                        adaptiveNavAlpha: nextConfig.adaptiveColors.navAlpha,
                        adaptiveTopAlpha: nextConfig.adaptiveColors.topAlpha
                    });
                    ...
                    try {
                        const updates: Array<[string, unknown]> = [
                            ...
                            ['adaptiveColorsRespectTransparency', Boolean(message.adaptiveColors?.respectTransparency)]
                        ];
