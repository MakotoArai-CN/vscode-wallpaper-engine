...
const adaptiveColorControls = {
  ...
  respectTransparency: document.getElementById("adaptive-colors-respect-transparency"),
};
...
function collectAdaptiveColorConfig() {
  return {
    ...
    respectTransparency: adaptiveColorControls.respectTransparency.checked,
  };
}
...
function updateGlassPreview() {
  ...
  adaptiveColorControls.respectTransparency.disabled = !adaptiveColors.enabled;
  updatePresetButtons();
}
...
const initialAdaptiveColors = window.adaptiveColorConfig || { enabled: true, strength: 0.68, respectTransparency: true };
...
adaptiveColorControls.respectTransparency.checked = initialAdaptiveColors.respectTransparency !== false;
